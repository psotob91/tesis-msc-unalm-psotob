...
## Options recomended for summarytools
...
#| label: importar
#| include: false
data_raw <- readRDS(here("Data/Tidy/data_raw.rds")) |> 
  clean_names()
```
...
score4c_gr = factor(case_when(
  ...
  death = case_when(
    fallec %in% c("No (historia lo indica)") ~ "Vivo", 
